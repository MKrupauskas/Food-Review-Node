  ...
  _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (res) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener("click", function () {
        var html = "\n          <div class=\"popup\">\n            <a href=\"/store/" + this.place.slug + "\">\n              <img src=\"/uploads/" + (this.place.photo || "store.png") + "\" alt=\"" + this.place.name + "\" />user\n              <p>" + this.place.name + " - " + this.place.location.address + "</p>\n            </a>\n          </div>\n        ";
...
var _autocomple = __webpack_require__(10);

var _autocomple2 = _interopRequireDefault(_autocomple);
...
(0, _autocomple2.default)((0, _bling.$)("#address"), (0, _bling.$)("#lat"), (0, _bling.$)("#lng"));
